...
namespace arduino {
  ...
  /* ----------------------------------------------------Methods-------------------------------------------------- */
  void Motor::turnOn(void) const noexcept {
    
  }

  void Motor::turnOff(void) const noexcept {

  }

  [[nodiscard]] bool Motor::isOn(void) const noexcept { return this->pin.digitalRead() == PinStatus::HIGH; }

  [[nodiscard]] bool Motor::isOff(void) const noexcept { return this->pin.digitalRead() == PinStatus::LOW; }
